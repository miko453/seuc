    ...
    <div className="relative">
      ...
      <section className="relative py-24 overflow-hidden border-b border-primary/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-block px-4 py-1.5 mb-6 text-xs font-mono font-bold tracking-widest text-accent border border-accent/30 rounded-full animate-pulse">
            [ 系统公告 ]：因村长家断电，全线节点预计下周二随机上线
          </div>
      ...
      <section className="py-20 bg-card/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-background/40 border-primary/30 transform transition hover:scale-[1.02] hover:-rotate-1 border-2">
              <CardContent className="p-8 text-center">
                <HardDrive className="h-12 w-12 text-primary mb-6 mx-auto" />
                <h3 className="text-2xl mb-4 font-headline text-accent">内存超开 1000%</h3>
            ...
            <Card className="bg-background/40 border-primary/30 transform transition hover:scale-[1.02] hover:rotate-1 border-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl mb-4 font-headline text-accent">地窖级冷却</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="bg-background/40 border-primary/30 transform transition hover:scale-[1.02] hover:-rotate-1 border-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl mb-4 font-headline text-accent">数据定期蒸发</h3>
                <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative aspect-video rounded-lg overflow-hidden border-4 border-primary/40 group">
              ...
              <div className="absolute bottom-4 left-4 bg-background/80 backdrop-blur px-3 py-1 text-xs font-mono border border-accent/50 text-accent">
                NODE_CUNKOU_01: 村长家地窖
              </div>
            </div>
            <div className="space-y-6">
              <h2 className="text-5xl font-headline tracking-tighter text-primary">“<span className="text-accent italic">邻居 WiFi</span>” 核心骨干网</h2>
              <p className="text-lg text-muted-foreground italic">
                我们的带宽是租来的？不，是蹭来的。邻居老王换密码之日，就是我们数据中心断网之时。
              </p>
              <ul className="space-y-4 font-mono text-sm uppercase">
                <li className="flex items-center gap-3">
                  <WifiOff className="h-5 w-5 text-accent" /> 带宽全靠老王不关路由
                </li>
                <li className="flex items-center gap-3">
                  <Zap className="h-5 w-5 text-accent" /> 极速 56kbps 拨号回国
                </li>
                <li className="flex items-center gap-3">
                  <CloudOff className="h-5 w-5 text-accent" /> 提供“流量卡”专用加速器
                </li>
              </ul>
              <Button asChild className="bg-accent text-black font-bold tracking-widest px-8 hover:bg-accent/80">
