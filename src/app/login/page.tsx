...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-4 border-primary bg-card/50 backdrop-blur-sm relative overflow-hidden shadow-2xl">
        ...
        <CardContent className="p-8">
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-widest text-primary font-bold">受害者 ID</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-widest text-primary font-bold">跑路暗号</label>
              <div className="relative">
            ...
            <Button disabled={loading} className="w-full bg-primary hover:bg-primary/80 text-white font-black h-12 shadow-lg">
              {loading ? "正在尝试贿赂数据库..." : "确认登录 (并上缴钱包)"}
            </Button>
          </form>
          
          <div className="mt-8 pt-6 border-t border-primary/10 flex flex-col gap-4 text-center">
            <Link href="/register" className="text-xs text-accent font-bold hover:underline flex items-center justify-center gap-1">
